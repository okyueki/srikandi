...
<div class="row">
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <?php endif; ?>
            <div class="card-body">
                <form action="<?php echo e(route('penilaian_individu.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-12">
                            
                            <div class="form-floating mb-3">
                                <input type="text" id="nik_atasan" name="nik_atasan" value="<?php echo e($nikAtasan); ?>" class="form-control" disabled>
                                <label for="nik_atasan">NIK Penilai</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" id="nama_atasan" name="nama_atasan" value="<?php echo e($namaAtasan); ?>" class="form-control" disabled>
                                <label for="nama_atasan">Nama Penilai</label>
                            </div>
                            
                            <div class="form-group">
                                <label for="bulan">Pilih Bulan:</label>
                                <input type="month" id="penilaian_bulan" name="penilaian_bulan" class="form-control" value="<?php echo e(old('penilaian_bulan', $bulan ?? now()->format('Y-m'))); ?>">
                            </div>
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/srikandi.rsaisyiyahsitifatimah.com/srikandi/resources/views/kpi/penilaian_individu_create.blade.php ENDPATH**/ ?>