<?php $__env->startSection('pageTitle', isset($pageTitle) ? $pageTitle : 'AI Dashboard'); ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="history-content">
                                        <?php if($recentInteractions->count() > 0): ?>
                                            <?php $__currentLoopData = $recentInteractions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $interaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="card mb-2">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between">
                                                        <small class="text-muted"><?php echo e($interaction->formatted_date); ?></small>
                                                        <span class="badge badge-<?php echo e($interaction->success ? 'success' : 'danger'); ?>">
                                                            <?php echo e($interaction->context); ?>

                                                        </span>
                                                    </div>
                                                    <p class="mb-1"><strong>Q:</strong> <?php echo e($interaction->truncated_message); ?></p>
                                                    <p class="mb-0"><strong>A:</strong> <?php echo e($interaction->truncated_response); ?></p>
                                                </div>
                                            </div>
...
function testConnection() {
    ...
    $.get('<?php echo e(route("ai.test-connection")); ?>')
...
function loadModels() {
    $.get('<?php echo e(route("ai.models")); ?>')
        .done(function(response) {
...
function analyzeMedicalText() {
    ...
    $.post('<?php echo e(route("ai.analyze-medical")); ?>', {
        text: text,
...
function generateReport() {
    ...
    $.post('<?php echo e(route("ai.generate-report")); ?>', {
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/srikandi.rsaisyiyahsitifatimah.com/srikandi/resources/views/ai/index.blade.php ENDPATH**/ ?>