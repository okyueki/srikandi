...
$(function () {
    $('#asuhan-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route('dischargenotepublic.index')); ?>',
         columns: [
...
</html><?php /**PATH /www/wwwroot/srikandi.rsaisyiyahsitifatimah.com/srikandi/resources/views/pages/dischargenotepublic.blade.php ENDPATH**/ ?>