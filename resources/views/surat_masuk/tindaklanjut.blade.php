...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <form action="{{ route('surat_masuk.tindaklanjutProses', $disposisiTerbaru->id_disposisi_surat) }}" method="POST">
                                            ...
                                            <div class="form-group" id="nik_penerima_container">
                                                ...
                                                <select name="nik_penerima" id="nik_penerima" class="form-control" required>
        ...
        function toggleFields() {
            if (statusSelect.value === 'Selesai') {
                ...
                catatanContainer.style.display = 'none'; // Sembunyikan catatan
            } else {
                nikPenerimaContainer.style.display = 'block'; // Tampilkan nik_penerima
                catatanContainer.style.display = 'block'; // Tampilkan catatan
            }
        }
