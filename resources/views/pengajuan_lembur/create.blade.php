                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-5 mb-3">
                                <div class="input-group">
                                    <input type="text" name="jam_awal" id="jam_awal" class="form-control flatpickr-time" value="{{ old('jam_awal') }}">
                                    <div class="input-group-text"><i class="fas fa-clock"></i></div>
                                </div>
                            </div>
                            <div class="col-5 mb-3">
                                <div class="input-group">
                                    <input type="text" name="jam_akhir" id="jam_akhir" class="form-control flatpickr-time" value="{{ old('jam_akhir') }}">
                                    <div class="input-group-text"><i class="fas fa-clock"></i></div>
                                </div>
                            </div>
