                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end main-header-message" data-popper-placement="none">
                            ...
                            <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                                <li class="dropdown-item">
                                    <div class="d-flex messages">
                                        <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                            <img src="./backend/assets/images/faces/12.jpg" alt="img">
                                        </span>
                                        <div>
                                            <div class="d-flex">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex messages">
                                        <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                            <img src="./backend/assets/images/faces/3.jpg" alt="img">
                                        </span>
                                        <div>
                                            <div class="d-flex">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex messages">
                                        <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                            <img src="./backend/assets/images/faces/5.jpg" alt="img">
                                        </span>
                                        <div>
                                            <div class="d-flex">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex messages">
                                        <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                            <img src="./backend/assets/images/faces/4.jpg" alt="img">
                                        </span>
                                        <div>
                                            <div class="d-flex">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex messages">
                                        <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                            <img src="./backend/assets/images/faces/1.jpg" alt="img">
                                        </span>
                                        <div>
                                            <div class="d-flex">
