...
<div class="form-group">
    <label for="kode_produsen" class="form-label">Produsen</label>
        <select id="kode_produsen" name="kode_produsen" class="js-example-basic-single form-control" required>
...
<div class="form-group">
    <label for="id_merk" class="form-label">Merk</label>
        <select name="id_merk" id="id_merk" class="js-example-basic-single form-controll" required>
...
<div class="form-group">
    ...
    <select name="id_kategori" id="id_kategori" class="js-example-basic-single form-controll" required>
...
<div class="form-group">
    ...
    <select name="id_jenis" id="id_jenis" class="js-example-basic-single form-controll" required>
